...
class MagiPageView: UIView {
    ...
    fileprivate(set) var contentView: MagiContentView!
    ...
    fileprivate func commonInit() {
        ...
        contentView = MagiContentView(frame: CGRect(x: 0, y: segView.frame.maxY,
                                                    width: bounds.size.width,
...
extension MagiPageView: MagiContentViewDelegate {
