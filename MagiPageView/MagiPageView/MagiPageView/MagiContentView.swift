...
public class MagiGestureCollectionView: UICollectionView {
    
    var panGestureShouldBeginClosure: ((_ panGesture: UIPanGestureRecognizer, _ collectionView: MagiGestureCollectionView) -> Bool)?
    
    func setupPanGestureShouldBeginClosure(_ closure: @escaping (_ panGesture: UIPanGestureRecognizer, _ collectionView: MagiGestureCollectionView) -> Bool) {
...
public protocol MagiContentViewDelegate: class {
    ...
    func contentViewShouldBeginPanGesture(panGesture: UIPanGestureRecognizer ,
                                          collectionView: MagiGestureCollectionView) -> Bool
...
extension MagiContentViewDelegate {
    ...
    public func contentViewShouldBeginPanGesture(panGesture: UIPanGestureRecognizer , collectionView: MagiGestureCollectionView) -> Bool {
        return true
    }
...
class MagiContentView: UIView {
    ...
    public weak var delegate: MagiContentViewDelegate?
    
    fileprivate(set) lazy var collectionView: MagiGestureCollectionView = {
        let flowLayout = UICollectionViewFlowLayout()
        
        let collection = MagiGestureCollectionView(frame: CGRect.zero,
        ...
        collection.register(UICollectionViewCell.self,
                            forCellWithReuseIdentifier: MagiContentView.cellId)
        return collection
    }()
...
extension MagiContentView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    final public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MagiContentView.cellId, for: indexPath)
...
extension MagiContentView: UIScrollViewDelegate {
    // update UI
